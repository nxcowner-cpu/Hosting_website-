...
app = Flask(__name__)
app.secret_key = "BABA_TILLU_HACKER_2026"

# --- Master Admin Credentials ---
ADMIN_USERNAME = "iamarru"
ADMIN_PASSWORD = "iamarru09"
...
<head>
    ...
    <title>BABA TILLU HACKER HOSTING PANEL</title>
...
<body>
    <nav>
        <div class="logo">⚡ BABA TILLU HACKER</div>
        <div class="nav-links">
...
<html>
<head>
    <title>BABA TILLU HACKER HOSTING - Login</title>
    <style>
        body {
            background: #050505;
            color: white;
...
<html>
<head>
    <title>Dashboard - BABA TILLU HACKER</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<html>
<head>
    <title>Pricing - BABA TILLU HACKER</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<html>
<head>
    <title>My Payments - BABA TILLU HACKER</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<html>
<head>
    <title>Admin Login - BABA TILLU HACKER</title>
    <style>
        body {
            background: #050505;
            color: white;
...
<html>
<head>
    <title>Admin Dashboard - BABA TILLU HACKER</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<body>
    <div class="header">
        <div class="logo">🛡️ BABA TILLU PANEL</div>
        <div class="nav">
...
<html>
<head>
    <title>Manage Plans - BABA TILLU HACKER</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<html>
<head>
    <title>Payment Methods - BABA TILLU HACKER</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<html>
<head>
    <title>Users - BABA TILLU HACKER</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<html>
<head>
    <title>Payments - BABA TILLU HACKER</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
